...
test.describe("Check validation for fields", ()=>{
    ...
    test ('Sign Up with INVALID data for Name input', async ({page})=>{
        ...
        await test.step('Negative: check required Name', async () => {
            ...
            const errorMessageRequiredName = popup.locator("#signupName + .invalid-feedback")
        ...
        await test.step('Negative: check Min length', async () => { 
            ...
            await inputName.blur()
            const errorMessageMinLengthName = popup.locator("#signupName + .invalid-feedback")
        ...
        await test.step('Negative: check Max Length', async () => { 
            ...
            await inputName.blur()
            const errorMessageMaxLengthName = popup.locator("#signupName + .invalid-feedback")
        ...
        await test.step('Negative: check Spaces', async () => {  
            ...
            await inputName.blur()
            const errorMessageSpacesName = popup.locator("#signupName + .invalid-feedback")
        ...
        await test.step('Negative: check Latin letters', async () => {
            ...
            await inputName.blur()
            const errorMessageLatinLettersName = popup.locator("#signupName + .invalid-feedback")
        ...
        await test.step('Negative: check Special Symbols', async () => {
            ...
            await inputName.blur()
            const errorMessageSpecialSymbolsName = popup.locator("#signupName + .invalid-feedback")
    ...
    test ('Sign Up with INVALID data for Last Name input', async ({page})=>{
        ...
        await test.step('Negative: check required Last Name', async () => {
            ...
            const errorMessageRequiredinputLastName = popup.locator("#signupLastName + .invalid-feedback")
        ...
        await test.step('Negative: check Min length Last Name', async () => { 
            ...
            await inputLastName.blur()
            const errorMessageMinLengthInputLastName = popup.locator("#signupLastName + .invalid-feedback")
        ...
        await test.step(' Negative: check Max Length Last Name', async () => {
            ...
            await inputLastName.blur()
            const errorMessageMaxLengthInputLastName = popup.locator("#signupLastName + .invalid-feedback")
        ...
        await test.step('Negative: check Spaces Last Name', async () => {
            ...
            await inputLastName.blur()
            const errorMessageSpacesInputLastName = popup.locator("#signupLastName + .invalid-feedback")
        ...
        await test.step('Negative: check Latin letters Last Name', async () => {
            ...
            await inputLastName.blur()
            const errorMessageLatinLettersInputLastName = popup.locator("#signupLastName + .invalid-feedback")
        ...
        await test.step('Negative: check Special Symbols Last Name', async () => {
            ...
            await inputLastName.blur()
            const errorMessageSpecialSymbolsInputLastName = popup.locator("#signupLastName + .invalid-feedback")
    ...
    test ('Sign Up with INVALID data for Email input', async ({page})=>{
        ...
        await test.step('Negative: check required Email', async () => {  
            ...
            const errorMessageRequiredInputEmail = popup.locator("#signupEmail + .invalid-feedback")
        ...
        await test.step('Negative: check invalid type, without @', async () => {
            ...
            await inputEmail.blur()
            const errorMessageSpacesInputEmail =  popup.locator("#signupEmail + .invalid-feedback")
        ...
        await test.step('Negative: check invalid type, without domen', async () => {
            ...
            await inputEmail.blur()
            const errorMessageLatinLettersInputEmail = popup.locator("#signupEmail + .invalid-feedback")
        ...
        await test.step('Negative: check Special Symbols', async () => {
            ...
            await inputEmail.blur()
            const errorMessageSpecialSymbolsInputEmail = popup.locator("#signupEmail + .invalid-feedback")
    ...
    test ('Sign Up with INVALID data for Password input', async ({page})=>{
        ...
        await test.step('Negative: check required Password', async () => {
            ...
            const errorMessageRequiredInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Min length ', async () => { 
            ...
            await inputPassword.blur()
            const errorMessageMinLengthInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Max length ', async () => { 
            ...
            await inputPassword.blur()
            const errorMessageMaxLengthInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without integer', async () => { 
            ...
            await inputPassword.blur()
            const errorMessageIntegerInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without uppercase letter', async () => {
            ...
            await inputPassword.blur()
            const errorMessageUppercaseInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without lowercase letter', async () => {
            ...
            await inputPassword.blur()
            const errorMessageLowercaseInputPassword = popup.locator("#signupPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Special Symbols only', async () => {
            ...
            await inputPassword.blur()
            const errorMessageSpecialSymbolsInputPassword = popup.locator("#signupPassword + .invalid-feedback")
    ...
    test ('Sign Up with INVALID data for Repeat Password input', async ({page})=>{
        ...
        await test.step('Negative: check required Repeat Password', async () => { 
            ...
            const errorMessageRequiredInputRepeatPassword = await popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Min length ', async () => {
            ...
            await inputRepeatPassword.blur()
            const errorMessageMinLengthInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Max length ', async () => { 
            ...
            await inputRepeatPassword.blur()
            const errorMessageMaxLengthInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without integer', async () => { 
            ...
            await inputRepeatPassword.blur()
            const errorMessageIntegerInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without uppercase letter', async () =>{ 
            ...
            await inputRepeatPassword.blur()
            const errorMessageUppercaseInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check without lowercase letter', async () => { 
            ...
            await inputRepeatPassword.blur()
            const errorMessageLowercaseInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check Special Symbols only', async () => { 
            ...
            await inputRepeatPassword.blur()
            const errorMessageSpecialSymbolsInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
        ...
        await test.step('Negative: check not matched passwords', async () => { 
            ...
            await inputRepeatPassword.blur()
            const errorMessageNotMachInputRepeatPassword = popup.locator("#signupRepeatPassword + .invalid-feedback")
